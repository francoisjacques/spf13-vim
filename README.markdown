...
The quickest option to install all three dependencies ([Git], [Curl], [Vim] and [spf13-vim]) via [spf13.vim package]. After running the [Chocolatey] install, execute the following commands on the _command prompt_:
